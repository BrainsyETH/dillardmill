...
export const metadata = {
  title: 'The Sebastian | Pine Valley',
  description: 'Book The Sebastian cabin at Pine Valley near Dillard Mill in the Missouri Ozarks.',
};

export default async function SebastianPage() {
  const unit = await getUnitBySlug('the-sebastian');
