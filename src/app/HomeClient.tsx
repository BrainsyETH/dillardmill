          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-white">Book Direct</div>
                  <div className="text-sm text-white/60">No platform fees</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-brand-stone mb-10">
              Book directly with us and skip the platform fees &mdash; same host,
              same property, lower total.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a
                ...
                className="text-brand-stone hover:text-brand-forest underline underline-offset-4 text-sm transition-colors"
              >
                Or browse on Airbnb
              </a>
            </div>
