...
export const metadata = {
  title: 'Tiny Cabin #2 | Pine Valley',
  description: 'Stay in Tiny Cabin #2 at Pine Valley near Dillard Mill. Queen bed, AC, perfect for couples. Missouri Ozarks getaway.',
};

export default async function TinyCabin2Page() {
  const unit = await getUnitBySlug('tiny-cabin-2');
